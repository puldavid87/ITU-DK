...
static uint8_t const matrix [4][4]= {{0x02,0x03,0x01,0x01},
                                     ...
                                     {0x01,0x01,0x02,0x03},
                                     {0x03,0x01,0x01,0x02}};
static uint8_t const key[16] ={0x54,0x68,0x61,0x74,0x73,0x20,0x6D,0x79,0x20,0x4B,0x75,0x6E,0x67,0x20,0x46,0x75};
static uint8_t const text[16]={0x54,0x77,0x6F,0x20,0x4F,0x6E,0x65,0x20,0x4E,0x69,0x6E,0x65,0x20,0x54,0x77,0x6F};
uint8_t i=0;
uint8_t j,k,h,l,m=0;
uint8_t temp;
uint8_t rounds [4][4];
...
uint8_t out [4][4];
uint8_t g [4];
static uint8_t rcon [4]={0x01,0x00,0x00,0x00};
void setup() {
